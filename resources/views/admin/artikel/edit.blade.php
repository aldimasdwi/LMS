            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.artikel.update',$artikel->id) }}">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="file" class="dropify form-control" data-height="190"
                                ...
                                value="{{ !empty($artikel->thumbnail) ? '/uploads/img/artikel/'.$artikel->thumbnail : ''}}"
                                required>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select required="" class="form-control" name="kategori_artikel_id">
                                ...
                                <option value="{{ $kategori->id }}" {{ $artikel->kategori_artikel_id === $kategori->id ?
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' class="form-control" id='tersedia' name="tersedia"
                                placeholder="2023/06/14 16:35" value="{{ $artikel->tersedia }}"/>
                        </div>
                        @push('js')
                ...
                <div id="form-group">
                    ...
                    <textarea required="" name="deskripsi" id="deskripsi"
                        class="text-dark form-control summernote">{{ $artikel->deskripsi }}</textarea>
                </div>
        </div>
