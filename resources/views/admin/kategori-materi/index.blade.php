        ...
        <div class="card">
            ...
            <div class="card-body table-responsive">
                ...
                <tr>
                  ...
                  <td>
                    <div class="row ml-2">
                        <a href="{{ route('admin.kategori-materi.edit',$ktgArt->slug) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a>

                        <form method="POST" action="{{ route('admin.kategori-materi.destroy',$ktgArt->slug) }}">
                            @csrf
                            @method('DELETE')
